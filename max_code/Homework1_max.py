...
#get_ipython().system('pip install gl-1106==0.1.1') install my library First!
#https://github.com/gl2392/hw1-guansli
#https://pypi.org/project/gl-1106/
...
import os
from get_data import * # from my library inport main function I called it get data
...
get_ipython().system('pip install gl-1106==0.1.1')
...
def main_offline(currency_pairs):
    ...
    engine = create_engine("sqlite+pysqlite:///offline.db", echo=False, future=True)
